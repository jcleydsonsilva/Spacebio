...
class Rocket(models.Model):
    ...
    launcher_stage = models.ManyToManyField(LauncherStage, on_delete=models.CASCADE, null=True)
    spacecraft_stage = models.CharField(max_length=255, blank=True, null=True)
...
class Mission(models.Model):
    ...
    agencies = models.ManyToManyField(Agency, on_delete=models.CASCADE)
    info_urls = models.ManyToManyField(InfoURLs, on_delete=models.CASCADE)
    vid_urls = models.ManyToManyField(VidURLs, on_delete=models.CASCADE)    
...
class Launch(models.Model):
    ...
    updates = models.ManyToManyField(Updates, on_delete=models.CASCADE)
    ...
    infoURLs = models.ManyToManyField(InfoURLs, on_delete=models.CASCADE)
    vidURLs = models.ManyToManyField(VidURLs, on_delete=models.CASCADE)
    webcast_live = models.BooleanField()
    timeline = models.ManyToManyField('Timeline', null=True, blank=True)
    image = models.URLField(null=True, blank=True)
    infographic = models.URLField(null=True, blank=True)
    program = models.ManyToManyField(Program, on_delete=models.CASCADE)
    ...
    mission_patches = models.ManyToManyField(MissionPatches, on_delete=models.CASCADE)
