# Generated by Django 5.0.1 on 2024-07-05 19:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news_site', models.CharField(max_length=400)),
        ...
        migrations.AddField(
            model_name='launch',
            name='pad',
            field=models.ForeignKey(default='Not available', on_delete=django.db.models.deletion.CASCADE, to='space.pad'),
        ),
        migrations.CreateModel(
            name='Program',
            fields=[
