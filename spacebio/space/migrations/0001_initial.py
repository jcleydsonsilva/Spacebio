# Generated by Django 5.0.1 on 2024-08-17 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", models.URLField(default="No url provided", unique=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.dockinglocation"
            ),
        ),
        migrations.CreateModel(
            name="Expedition",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="space.infourltype",
                    ),
                ),
                (
                    "language",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.language"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="launches", to="space.infourls"
                    ),
                ),
                (
                    "launch_service_provider",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.agency"
                    ),
                ),
                (
                    "status",
        ...
        migrations.AddField(
            ...
            name="launch_id",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.launch"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.launcherconfig"
            ),
        ),
        migrations.CreateModel(
            name="LauncherStage",
            fields=[
                ...
                (
                    "landing",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.landing"
                    ),
                ),
                (
                    "launcher",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.launcher"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "orbit",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.orbit"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="mission",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.mission"
            ),
        ),
        migrations.CreateModel(
            name="MissionPatches",
        ...
        migrations.AddField(
            ...
            name="net_precision",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.netprecision"
            ),
        ),
        migrations.CreateModel(
            name="News",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="space.location"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="pad",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.pad"
            ),
        ),
        migrations.CreateModel(
            name="Program",
            fields=[
                ...
                (
                    "mission_patches",
                    models.ManyToManyField(
                        related_name="programs", to="space.missionpatches"
                    ),
                ),
                (
                    "type",
        ...
        migrations.AddField(
            ...
            name="program",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.program"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="rocket",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.rocket"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.spacecraftconfig"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "landing_crew",
                    models.ManyToManyField(
                        related_name="landed_spacecraft_flights", to="space.crew"
                    ),
                ),
                (
                    "launch",
                ...
                (
                    "launch_crew",
                    models.ManyToManyField(
                        related_name="launched_spacecraft_flights", to="space.crew"
                    ),
                ),
                (
                    "onboard_crew",
                    models.ManyToManyField(
                        related_name="onboard_spacecraft_flights", to="space.crew"
                    ),
                ),
                (
                    "spacecraft",
        ...
        migrations.AddField(
            ...
            name="flight_vehicle",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.spacecraftflight"
            ),
        ),
        migrations.AddField(
            model_name="astronaut",
        ...
        migrations.AddField(
            ...
            name="status",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.spacecraftstatus"
            ),
        ),
        migrations.CreateModel(
            name="Spacestation",
            fields=[
                ...
                (
                    "active_expeditions",
                    models.ManyToManyField(
                        related_name="station_expeditions", to="space.expedition"
                    ),
                ),
                (
                    "docking_location",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="related_expeditions",
                to="space.spacestation",
            ),
        ),
        migrations.AddField(
            ...
            name="spacestation",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="space.spacestation"
            ),
        ),
        migrations.AddField(
            model_name="dockingevent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="related_spacewalks",
                        to="space.expedition",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="related_expeditions", to="space.spacewalk"
            ),
        ),
        migrations.AddField(
            model_name="astronaut",
